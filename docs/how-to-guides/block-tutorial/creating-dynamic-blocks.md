...
If you are using [Inner Blocks](/docs/how-to-guides/block-tutorial/nested-blocks-inner-blocks.md) in a dynamic block you will need to save the inner blocks in the `save` callback function using `useInnerBlocksProps` hook.
